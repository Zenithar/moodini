...
func Build() {
	banner := figure.NewFigure("Moodini", "", true)
	banner.Print()
...
func (Gen) Wire() {
	...
	// mustGoGenerate("HTTP", "go.zenithar.org/moodini/cli/moodini/internal/dispatchers/http")
}
...
func (Bin) Moodini() error {
	return goBuild("go.zenithar.org/moodini/cli/moodini", "moodini")
}
...
func goBuild(packageName, out string) error {
	...
	varsSetByLinker := map[string]string{
		"go.zenithar.org/moodini/internal/version.Version":   tag(),
		"go.zenithar.org/moodini/internal/version.Revision":  hash(),
		"go.zenithar.org/moodini/internal/version.Branch":    branch(),
		"go.zenithar.org/moodini/internal/version.BuildUser": os.Getenv("USER"),
		"go.zenithar.org/moodini/internal/version.BuildDate": time.Now().Format(time.RFC3339),
		"go.zenithar.org/moodini/internal/version.GoVersion": runtime.Version(),
	}
